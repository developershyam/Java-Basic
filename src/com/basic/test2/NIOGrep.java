...
public class NIOGrep {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String grepfor = "MAPSIZE";
        Path path = Paths.get("src/com/basic/test2/NIOGrep.java");
    ...
    private static final int MAPSIZE = 4 * 1024 ; // 4K - make this * 1024 to 4MB in a real system. MAPSIZE
