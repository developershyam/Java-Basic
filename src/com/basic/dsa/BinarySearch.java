...
public class BinarySearch {
	...
	public static void main(String[] args) {
		...
		System.out.println("Key 14's position binarySearch: " + binarySearch(arr, 7)+"   ,  loopCount: "+loopCount);
		System.out.println("Key 14's position interpolationSearch: " + interpolationSearch(arr, 7)+"   ,  loopCount: "+loopCount);
